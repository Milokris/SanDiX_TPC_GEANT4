...
//World Volume
    G4Material *worldMat = nist->FindOrBuildMaterial("G4_Galactic"); // G4_Galactic or G4_AIR
...
//////////////////////////////////////////////////////////////
/////CHANGED XENON TO AIR TO SEE IF IT INCREASED ELECTRON DRIFT
//////////////////////////////////////////////////////////////
...
logicWorld, false, 0, checkOverlaps);
    ...
    //G4UserLimits* limits = new G4UserLimits(0.001*mm);  // 1 micron
    //logicChamber->SetUserLimits(limits);
...
//Stainless Steel frame
    ...
    G4Tubs *steelFrame1 = new G4Tubs("steelFrame1", xenonRadius, xenonRadius + steelRingThickness,
steelHalfThickness, 0, 360*deg);
    G4Tubs *steelFrame2 = new G4Tubs("steelFrame2", xenonRadius, xenonRadius + steelRingThickness,
steelHalfThickness, 0, 360*deg);
